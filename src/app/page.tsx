    ...
    <main className="flex flex-col min-h-[100dvh] space-y-10">
      ...
      <section id="about">
        <BlurFade delay={BLUR_FADE_DELAY * 3}>
          <h2 className="text-xl font-bold mb-2">À propos de moi</h2>
        </BlurFade>
      ...
      <section id="skills">
        <div className="flex min-h-0 flex-col gap-y-3">
          <BlurFade delay={BLUR_FADE_DELAY * 9}>
            <h2 className="text-xl font-bold">Compétences et technologies que je maîtrise</h2>
          </BlurFade>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">
                  Présentation de mes derniers travaux
                </h2>
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  J&apos;ai travaillé sur de nombreux projets, allant d&apos;un simple site web au développement d&apos;applications complexes
                  utilisant de l&apos;intelligence artificielle et du web sémantique.
                </p>
              </div>
            </div>
          </BlurFade>
